...
//////////////////////////////////////////////////////////////////////////
//
// Denne filen inneholder eksempel pÂ callback-rutiner som kalles
// av FYBA for feilmeldings-handtering og visning av framdrift under
// indeksoppbygging.
//
// For Â fÂ et godt brukergrensesnitt b¯r disse rutinene endres til
    ...
    if (strategi > 0) {
       ...
       switch(strategi) {                           /* Velg strategi */
           ...
           case 2:
               break;
           case 3:
               printf("\aTrykk [Enter] for Â fortsette:");
					if (getchar() == 0)  getchar();
               break;
			  case 4:
					printf("\aTrykk [Enter] for Â avbryte programmet:");
					if (getchar() == 0)  getchar();
					exit(2);
					break;
		 }
...
CD ==========================================================================
CD FormÂl:
CD Sjekk om det er trykt pÂ Esc (Avbryte indeksoppbygging).
CD
CD Parametre:
CD Type   Navn      I/U   Forklaring
CD --------------------------------------------------------------------------
