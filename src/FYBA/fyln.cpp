...
short LN_Enhet(LC_NAVNETABELL * pLn,char *ginfo_linje)
{
   ...
   //JAØ-20000313
   //Leter etter "..ENHET " istedet for "..ENHET" for ikke Â fÂ tilslag pÂ ..ENHET-H eller ..ENHET-D
...
short LN_EnhetHoyde(LC_NAVNETABELL * pLn,char *ginfo_linje)
{
   ...
   // Leter etter "..ENHET-H " istedet for "..ENHET-H" for ikke Â fÂ tilslag pÂ andre navn
...
short LN_EnhetDybde(LC_NAVNETABELL * pLn,char *ginfo_linje)
{
   ...
   // Leter etter "..ENHET-D " istedet for "..ENHET-D" for ikke Â fÂ tilslag pÂ andre navn
...
CD Denne tabellen inneholder bÂde gruppenavn (.LINJE, .KURVE, ...) og
CD egenskapsnavn (..OBJTYPE, ..LTEMA, ...)
CD
CD Tabellen har tre logiske deler:
CD  - (Linje 0 - L_HODE): ForhÂndsdefinerte gruppenavn.
CD  - (Linje L_HODE+1 - L_KP): ForhÂndsdefinerte egenskapsnavn.
...
CD                          Hvis det har vÊrt en gruppe som har brukt navnet blir
CD                          denne stÂende "true" selv om gruppen er slettet.
CD const char *pszNavn  r   Peker til elementnavn, 
CD                          NULL = ukjent fil eller ulovlig linjenummer
CD
CD
CD Bruk:
CD // GÂr gjennom alle navnene ut over de forhÂndsdefinerte navnene.
...
CD Resultatet legges i en intern streng, og mÂ kopieres over til andre
...
/*
AR: 2000-01-19
CH LC_FinnNivo                                     Beregn nivÂ
CD ==============================================================
CD FormÂl:
CD Teller antall prikker i starten pÂ egenskapsnavn.
CD
CD PARAMETERLISTE:
