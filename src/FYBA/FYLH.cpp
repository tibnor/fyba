...
CD
CD Rutiner for Â handtere hodet pÂ SOSI-filer nÂr dette ligger
CD som ginfo i RB.
CD  ==============================================================
*/
...
CD
CD MÂ velge mellom KOORDSYS, TRANSSYS eller GEOSYS.
CD Kun en av disse kan benyttes i filhodet. 
CD KOORDSYS er den mest vanlige mÂte Â definere referansesystem. 
CD 
CD GEOKOORD skal benyttes for GEOSYS og for TRANSSYS 
CD
CD MÂ velge mellom VERT-DATUM eller VERT-INT.
CD VERT-DATUM er den mest vanlige beskrivelsesmÂten. 
CD
...
SK_EntPnt_FYBA short LC_PutTransEx(unsigned short usMaske, LC_TRANSPAR * pTrans)
{
   ...
   if (LC_GetGP("..TRANSPAR",&lin,ngi) != NULL) {      
      ...
      /* i peker nÂ til f¯rste linje etter hele ..TRANSPAR med undernivÂer */
...
CD
CD MÂ velge mellom KOORDSYS, TRANSSYS eller GEOSYS. Kun en av disse kan benyttes i filhodet. 
CD KOORDSYS er den mest vanlige mÂte Â definere referansesystem. 
CD 
CD GEOKOORD skal benyttes for GEOSYS og for TRANSSYS 
CD
...
CD ==========================================================================
CD FormÂl:
CD Legger inn omrÂde i ginfo i aktuell gruppe.
...
CD ==========================================================================
CD FormÂl:
CD Henter ut omrÂde fra ginfo i aktuell gruppe.
CD OBS! Forutsetter at aktuell gruppe er et SOSI-filhode.
CD
CD Parametre:
CD Type     Navn      I/U   Forklaring
CD --------------------------------------------------------------------------
CD double  *nv_a       u    OmrÂde
CD double  *nv_n       u
CD double  *oh_a       u
CD double  *oh_n       u
CD short    ist        r    status: UT_TRUE=OK, UT_FALSE=feil (navn er ikke funnet)
