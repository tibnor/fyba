                        ...
                        double *af,double *nf)
{
   ...
   /* ---------- Skrå linje */
   if ( ! beregnet) {
      //JA¯-20001205 Prøver ny metode å beregne fotpunkt, pga avrundingsproblemer ved små verdier.
      ...
      //JA¯-20001205 Fjernet gammel måte å beregne fotpunkt, pga avrundingsproblemer ved små verdier.
      /*
      // Parametre for 1-2
...
CD double   nvn      u
CD double   oha      u    ¯vre høyre hjørne  av omskrevet rektangel.
CD double   ohn      u
CD
CD Bruk:
